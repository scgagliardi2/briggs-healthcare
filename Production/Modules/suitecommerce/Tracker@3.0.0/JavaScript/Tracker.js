	...
	)
{
	...
	{ var options = _.parseUrlOptions(location.search) , key = options.keywords || ''; listName = listName || (key ? 'Search Results' : 'Category'); if (!this.trackOnce[listName]) { this.trackOnce[listName] = true; 
