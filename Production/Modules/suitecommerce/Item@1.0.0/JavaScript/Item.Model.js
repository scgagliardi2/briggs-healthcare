		...
		,	initialize: function initialize ()
			{
				...
				// TODO CHANGE THE searchApiMasterOptions.itemDetails as it is easy misunderstood as the old product details!
		...
		,	getPosibleOptions: function getPosibleOptions ()
			{
				...
				if (this.get('_optionsDetails') && this.get('_optionsDetails').fields)
				{
					...
					_.each(fields, function (option_details)
					{
						...
						//TODO ADD IN THE ITEMOPTIONS CONFIG A <<GENERAL OPTION>> TO CONFIUGURE URL WITH LABELS AS KEY!
						//TODO ADD IN THE ITEMOPTIONS CONFIG A <<GENERAL OPTION>> TO CONFIUGURE URL WITH LABEL'S VALUE AS VALUE!
						};
