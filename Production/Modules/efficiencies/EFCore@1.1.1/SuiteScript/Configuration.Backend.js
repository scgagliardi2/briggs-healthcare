...
define('Configuration.Backend'
,	[
		'Utils'
	,	'underscore'
	,	'SC.Models.Init.Backend'
	,	'Console'
	]
,	function(
		Utils
...
/*
	...
	SC.Configuration.categories = nlapiGetContext().getSetting('FEATURE', 'COMMERCECATEGORIES') === 'T' ? SC.Configuration.categories : false;
