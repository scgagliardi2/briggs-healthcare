		...
		<div class="list-header-view-accordion" data-action="accordion-header">
			...
			<div class="list-header-view-accordion-body {{initiallyCollapsed}}" data-type="accordion-body" {{{accordionStyle}}}>
				...
				<div class="list-header-view-accordion-body-header {{classes}}">
					...
					{{#if poNumberSearch}}
						<div class="list-header-ponumber-search">
							{{#if poNumberVal}}
								<i class="list-header-ponumber-clear-icon" data-action="clearPoNumberHandler"></i>
							{{/if}}
							<input type="text" id="ponumber" name="ponumber" placeholder="Purchase No." class="list-header-ponumber-input" value="{{poNumberVal}}">
							<i class="list-header-ponumber-search-icon" data-action="ponumberHandler"></i>
						</div>
					{{/if}}
