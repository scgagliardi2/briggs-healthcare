    ...
    <div class="footer-content-newsletter-social">
        ...
        <div class="footer-content-social">
            ...
            {{#each socialMediaLinks}}
                <li><a {{objectToAtrributes item}} data-hashtag="{{datahashtag}}" data-touchpoint="{{datatouchpoint}}" target="{{datatarget}}">{{#if icon}}<i class="footer-content-social-icon icon-{{icon}}"></i>{{else}}{{text}}{{/if}}</a></li>
            {{/each}}
            </ul>
        </div>
        {{/if}}
    ...
    <div class="footer-columns-container">
        <div class="footer-columns">
            ...
            <div class="footer-column-links">
                ...
                {{#each col1Links}}
                {{#if href}}
                    <li class="footer-column-link-listitem"><a class="footer-column-link" {{objectToAtrributes item}} data-hashtag="{{datahashtag}}" data-touchpoint="{{datatouchpoint}}" target="{{datatarget}}">{{text}}</a></li>
                {{else}}
