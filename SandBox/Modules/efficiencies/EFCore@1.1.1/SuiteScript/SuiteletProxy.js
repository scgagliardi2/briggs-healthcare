    ...
    _.extend(SuiteletProxy.prototype, {
        ...
        cacheGet: function cacheRead() {
            ...
            try {
                ...
                console.warn('ERROR ON CACHE', e);  // eslint-disable-line no-console
                return false;
            }
        ...
        cachePut: function cachePut(data) {
            ...
            if (this.options.cache && this.options.cache.enabled && this.options.cache.ttl > 0) {
                try {
                    ...
                    console.warn('ERROR WHILE STORING ON CACHE', e); // eslint-disable-line no-console
                }
            } else {
                return false;
            }
