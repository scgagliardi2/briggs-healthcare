define('ProductReviewGoogleRecaptcha.validate', [
 ...
 // frontend validation
    ProductFormReviews.prototype.customSaveForm =
        _.wrap(ProductFormReviews.prototype.customSaveForm, function wrapProductFormInitialize(fn) {
            var resp;
